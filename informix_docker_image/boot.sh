...
EOF"
               dbaccess - graphdb.sql
               cd /opt/ibm/cayley/
               go mod download
               go build ./cmd/cayley
               /opt/ibm/cayley/cayley init -c /etc/config.json
               /opt/ibm/cayley/cayley load -c /etc/config.json -i data/testdata.nq
               /opt/ibm/cayley/cayley http --config=/etc/config.json --host=0.0.0.0:64210
               cd -
               onstat -m
